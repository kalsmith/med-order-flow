...
<head>
    ...
    <style>
        ...
        body {
            ...
            margin: 0; padding: 0 0 180px 0;
            font-size: 11px; color: #2d3436; line-height: 1.4;
            background-color: #ffffff;
        }

        /* Marca de agua de auditoría exclusiva para Staff */
        .watermark {
            position: fixed; top: 45%; left: 15%; transform: rotate(-45deg);
            font-size: 80px; color: rgba(220, 53, 69, 0.08);
            font-weight: bold; z-index: -1000; text-transform: uppercase;
        }
        ...
        .id-badge { background-color: #f8f9fa; border: 1px solid #e9ecef; border-radius: 6px; padding: 12px 18px; }
        .document-title { padding: 0 50px; font-size: 24px; font-weight: bold; margin-bottom: 30px; color: #2d3436; }
        .section { margin: 0 50px 20px 50px; border-top: 1px solid #edf2f7; padding-top: 15px; }
        .section-title { width: 120px; font-size: 9px; font-weight: bold; color: #0d6efd; text-transform: uppercase; vertical-align: top; }
        ...
        .prestacion-card { background-color: #f1f7ff; border-left: 4px solid #0d6efd; padding: 15px 20px; border-radius: 4px; }
        .exam-item { margin-bottom: 5px; padding-bottom: 3px; border-bottom: 1px dotted #d1e1f5; display: block; }
        .exam-code { color: #0d6efd; font-weight: bold; font-size: 9px; margin-right: 5px; }
        .footer-fixed { position: absolute; bottom: 0; width: 100%; height: 160px; }
        .qr-container { margin: 0 50px 20px 50px; background-color: #f8f9fa; border-radius: 8px; padding: 15px; border: 1px solid #e9ecef; }
        .legal-footer { border-top: 1px solid #edf2f7; padding: 15px 50px; text-align: center; font-size: 9px; color: #b2bec3; }
...
<div class="watermark">COPIA AUDITORÍA</div>
                    ...
                    <table width="100%">
                        <tr>
                            <td>
                                ...
                                <div class="value" style="margin:0;">{{ $prescription->signed_at ? $prescription->signed_at->format('d/m/Y') : now()->format('d/m/Y') }}</div>
                            </td>
                            <td align="right">
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td width="40%" align="right" style="vertical-align: middle;">
                            ...
                            @else
                                <div style="color: #b2bec3; font-style: italic; font-size: 8px;">
            ...
            <td>
                <div class="prestacion-card">
                    <div class="value" style="font-size: 14px; color: #0d6efd; margin-bottom: 8px; border-bottom: 1px solid #cce0ff; padding-bottom: 5px;">
                        {{ $order->type === 'custom' ? 'ORDEN MÉDICA' : ($order->examType->name ?? 'EXAMEN ESTÁNDAR') }}
                    </div>
...
<div class="footer-fixed">
        ...
        <table width="100%">
            <tr>
                ...
                <td style="padding-left: 15px; vertical-align: middle;">
                    <div style="color: #0d6efd; font-weight: bold; font-size: 10px; margin-bottom: 3px;">AUDITORÍA DE GESTIÓN</div>
                    <div style="color: #636e72; font-size: 9px;">
                        Verificación: pidetuexamen.cl/v/{{ $prescription->verification_code }}
    ...
    <div class="legal-footer">
        DOCUMENTO PARA USO INTERNO DE STAFF • GENERADO: {{ now()->format('d/m/Y H:i') }}
    </div>
</div>
