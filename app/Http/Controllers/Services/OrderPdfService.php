...
{
    /**
     * Genera el PDF basado en la orden y su receta activa.
     */
    public function generate(Order $order)
    {
        // 1. CARGA DE RELACIONES
        // Usamos loadMissing para no recargar si ya existen
        $order->loadMissing([
            'patient',
        ...
        // Si es una orden estándar, cargamos los hijos del tipo de examen
        if ($prescription->type === 'standard' && $prescription->exam_type_id) {
            $prescription->loadMissing('examType.children');
        }
